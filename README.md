...
Thank you to Emily Bache for creating this kata.

How to Practice the Kata in a group/mob session by GIT push/pull handover
====================================

In the following steps, one from the group will fork the repo, add collaborators, each of you clone the forked repo and you can start the Kata in a common Mob session!
...
Practice the Kata in a common Mob session
----------------
1. The new driver pulls all the previous changes and starts sharing his screen
2. You enjoy the mobbing
3. When the limit is done, the last commit is created
4. All commits are pushed to the common repository
5. Drivers are switched, and the new driver starts with point 1 (pull + sharing his screen)
...
* get feedback on the format of the session -> just contact us and describe how we can help you
...
Best practices
====================================
* Do commits as small as possible, so you can easily revert the changes if you go the wrong way anytime
* Switch Driver regularly
* I recommend starting with 7 minutes for switching a Driver (and experiment with that during the next session)
* Experiment with navigators (e.g. just one can navigate or everybody navigates)
* Have fun and learn something new from others!

Do not hesitate to mention your activity and provide a link on your code during a job interview in any company!
====================================
